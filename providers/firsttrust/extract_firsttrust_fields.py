...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output", type=Path, help="Processed CSV path. Defaults to a date folder inside ./firsttrust.")
...
def build_output_path(output_dir: Path) -> Path:
    return build_run_output_dir(output_dir) / "firsttrust_selected_fields.csv"
