"""Extract selected AllianceBernstein ETF fields from the latest scraper CSV."""
...
FALLBACK_FILENAME = "alliance_bernstein_selected_fields.csv"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Extract ETF Name, Issuer, ISIN, CCY, TER(bps), AUM(M), and Date from AllianceBernstein ETF snapshot."
    )
    parser.add_argument("--input", type=Path, help="AllianceBernstein raw snapshot path. Defaults to latest.")
