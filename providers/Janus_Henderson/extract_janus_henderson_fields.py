...
def parse_snapshot(path: Path) -> tuple[str, list[dict[str, object]], list[str]]:
    ...
    missing_target_isins = payload.get("missing_target_isins", [])
    if not isinstance(missing_target_isins, list):
