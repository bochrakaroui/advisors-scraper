...
INPUT_DIR = BASE_DIR / "jpmorgan_downloads"
OUTPUT_DIR = BASE_DIR / "jpmorgan_processed"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output", type=Path, help="Processed CSV path. Defaults to ./jpmorgan_processed.")
...
def build_output_path(output_dir: Path) -> Path:
    ...
    return output_dir / f"jpmorgan_selected_fields_{timestamp}.csv"
