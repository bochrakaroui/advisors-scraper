...
INPUT_DIR = BASE_DIR / "wisdomtree_downloads"
OUTPUT_DIR = BASE_DIR / "wisdomtree_processed"
ISSUER = "WisdomTree"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output", type=Path, help="Processed CSV path. Defaults to ./wisdomtree_processed.")
...
def build_output_path(output_dir: Path) -> Path:
    ...
    return output_dir / f"wisdomtree_selected_fields_{timestamp}.csv"
